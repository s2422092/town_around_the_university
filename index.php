...
<main>
  ...
  <section class="hero-section">
    ...
    <div class="hero-actions">
      <a class="btn btn-accent" href="register.php">無料で始める</a>
      <a class="btn btn-outline" style="border-color:#fff;color:#fff;" href="home.php">エリアを見る</a>
    </div>
  </section>
  ...
  <div class="card" style="text-align:center; padding: 2rem;">
    ...
    <a class="btn btn-primary" href="university.php">大学情報を入力する →</a>
  </div>
